...
interface Window {
  __tgWhisperTranscribeMedia?: (mediaData: unknown, message: unknown) => boolean | Promise<boolean>;
  __tgWhisperQueueMedia?: (mediaData: unknown, message: unknown) => boolean | Promise<boolean>;
  __tgWhisperTranscriptCache?: { clear: () => void };
}
