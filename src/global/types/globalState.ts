...
import type { AiWorkspaceState } from './aiWorkspace';
...
export type GlobalState = {
  ...
  /**
   * AI workspace state for the client-only AI sidebar feature.
   * Holds the service supergroup reference, per-source-chat topic mappings,
   * and synchronization metadata required to rebuild AI conversation history
