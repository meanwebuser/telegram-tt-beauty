...
import type { AiSourceChat } from './aiWorkspace';
...
export interface ActionPayloads {
  ...
  // ai workspace
  initializeAiWorkspace: WithTabId | undefined;
  createAndEnableAiWorkspace: WithTabId | undefined;
  createAiTopic: {
    sourceChat: AiSourceChat;
  ...
  cancelAiPrompt: WithTabId | undefined;
  appendAiStreamChunk: {
    text: string;
    isDone: boolean;
  } & WithTabId;
  ...
  setAiAssistantSettings: Partial<{
    apiKey?: string;
    endpoint?: string;
    model?: string;
    stream?: boolean;
  ...
  closeAiSidebar: WithTabId | undefined;
