...
"UserTypingMany_one" = "{user} and {count} more are typing";
...
"PageContentUnsupported" = "Unsupported content";
"PageContentEmbed" = "Embedded content";
...
"ReportButton" = "Report";
"ReportChatMessagesRequired" = "Select messages to include in your report.";
...
"SettingsAutomaticTextReplacements" = "Automatic text replacements";
"SettingsAutomaticTextReplacementsInfo" = "Convert --, << and >> as you type";
...
"RequestToJoinChannelDeclined" = "Your request to join the channel was declined.";
"RequestToJoinGroupDeclined" = "Your request to join the group was declined.";
"ChannelJoin" = "JOIN";
...
"AttachVideoMessage" = "Video Message";
"PlayOnceVideoMessageTooltip" = "This video message can only be played once.";
...
"VideoMessagePermissionDenied" = "To record video messages, allow access to your camera and microphone.";
"VideoMessageRecordError" = "Couldn't record a video message. Please check your camera and try again.";
"VideoMessagesRestrictedByPrivacy" = "**{user}** doesn't accept video messages.";
...
"PollRestrictToSubscribers" = "Restrict to Subscribers";
"PollRestrictToSubscribersDescription" = "Only subscribers who joined 24+ hours ago can vote.";
"PollLimitByCountry" = "Limit by Country";
"PollLimitByCountryDescription" = "Only users from selected countries can vote.";
"PollSubscriberRestriction" = "Only subscribers of {channel} can vote.";
"PollCountryRestriction" = "Only users from **{countries}** can vote.";
"PollAllowedCountries" = "Allowed Countries";
"PollCountriesCount_one" = "{count} country";
"PollCountriesCount_other" = "{count} countries";
"PollChooseCountry" = "Please choose at least one country.";
"PollCountriesLimit_one" = "You can choose up to {count} country.";
"PollCountriesLimit_other" = "You can choose up to {count} countries.";
...
"ErrorRichMessageTooManyBlocks_one" = "The message has too many blocks. Please remove {count} block.";
"ErrorRichMessageTooManyBlocks_other" = "The message has too many blocks. Please remove {count} blocks.";
"ErrorRichMessageTooDeep" = "The message is nested too deeply. The maximum depth is {count}.";
"ErrorRichMessageTooManyMedia_one" = "The message has too many media items. Please remove {count} item.";
"ErrorRichMessageTooManyMedia_other" = "The message has too many media items. Please remove {count} items.";
"ErrorRichMessageTableTooWide" = "A table in the message has too many columns. The maximum is {count}.";
...
"PollResultsAnswerTitle" = "{answer} - {percent}%";
"TimeIn" = "in {time}";
...
"ViewAction" = "View";
"RichMessageMore" = "Show more";
"RichTextEditor" = "Rich Text Editor";
"AriaComposerOpenRichInput" = "Open full editor";
"RichTextMathPreview" = "[formula]";
"RichTextMapPreview" = "[map]";
"Loading" = "Loading...";
...
"MessageMetaEditedAtTime" = "edited at {time}";
"MessageMetaEditedOnDateAtTime" = "edited on {date} at {time}";
...
"Reactions" = "Reactions";
"DeleteReactionTitle_one" = "Delete {count} Reaction?";
"DeleteReactionTitle_other" = "Delete {count} Reactions?";
"DeleteAllMessages" = "Delete all messages";
"DeleteAllReactions" = "Delete all reactions";
"DeleteReactionTooltip" = "Delete reaction";
"ReactionDeleted_one" = "Reaction Deleted";
"ReactionDeleted_other" = "Reactions Deleted";
...
"UserRestrictionsSendReactions" = "Send Reactions";
...
"ApproveNewMembersPublicUnavailable" = "This option is unavailable because anyone can join and send messages through the public group link.";
"ApproveNewSubscribersPublicUnavailable" = "This option is unavailable because anyone can join the public channel through the link.";
"GuardApproveNewMembers" = "Approve new members";
"GuardApproveNewChannelSubscribersInfo" = "An admin must approve users who want to join the channel.";
"GuardApproveNewPrivateGroupMembersInfo" = "An admin must approve users who want to join the group.";
"GuardApproveNewPublicGroupMembersInfo" = "An admin must approve anyone who wants to send a message in the group.";
"GuardApplyToInvitesTitle" = "Apply to existing invite links?";
"GuardApplyToInvitesApply" = "Apply";
"GuardApplyToInvitesDontApply" = "Don't Apply";
"GuardApplyToInvitesGroup_one" = "Also enable **Approve New Members** for **1 existing invite link** in this group?";
"GuardApplyToInvitesGroup_other" = "Also enable **Approve New Members** for **{count} existing invite links** in this group?";
"GuardApplyToInvitesChannel_one" = "Also enable **Approve New Subscribers** for **1 existing invite link** in this channel?";
"GuardApplyToInvitesChannel_other" = "Also enable **Approve New Subscribers** for **{count} existing invite links** in this channel?";
"GuardDisableInvitesGroup_one" = "Also disable **Approve New Members** for **1 existing invite link** in this group?";
"GuardDisableInvitesGroup_other" = "Also disable **Approve New Members** for **{count} existing invite links** in this group?";
"GuardDisableInvitesChannel_one" = "Also disable **Approve New Subscribers** for **1 existing invite link** in this channel?";
"GuardDisableInvitesChannel_other" = "Also disable **Approve New Subscribers** for **{count} existing invite links** in this channel?";
"GuardProcessJoinRequests" = "Process Join Requests";
"GuardProcessJoinRequestsInfo" = "Allow this bot to approve new members using its own interfaces, such as captchas.";
"GuardProcessJoinRequestsEnableGroup" = "New members will now need approval from {bot} before they can send messages in this group.";
"GuardProcessJoinRequestsDisableGroup" = "New members will no longer need approval from {bot} before they can send messages in this group.";
"GuardProcessJoinRequestsEnableChannel" = "New subscribers will now need approval from {bot} before they can join this channel.";
"GuardProcessJoinRequestsDisableChannel" = "New subscribers will no longer need approval from {bot} before they can join this channel.";
"Enable" = "Enable";
"Disable" = "Disable";
"ReplaceGuardBotTitle" = "Replace Guard Bot";
"ReplaceGuardBotDescription" = "**{current}** is currently processing join requests. Switch to **{new}** instead?";
"ReplaceGuardBotKeep" = "Keep {bot}";
"ReplaceGuardBotUse" = "Use {bot}";
"GuardManagedBy" = "Managed by {bot}";
"GuardManagedByDescription" = "{approvalInfo} {managedBy}";
"InviteLinkApprovalRequired" = "approval required";
...
"ChangeYourProfilePicture" = "Change your profile photo";
...
"ComposerPlaceholderBotTopicGeneral" = "Off-topic message";
...
"VoiceRecordMicError" = "Allow access to your microphone to record voice messages";
"AriaComposerPauseVoice" = "Pause voice recording";
"AriaComposerResumeVoice" = "Resume voice recording";
"AriaComposerPauseVideo" = "Pause video recording";
"AriaComposerResumeVideo" = "Resume video recording";
"AriaComposerPlayVoice" = "Play voice recording";
"AriaComposerPausePlayback" = "Pause playback";
...
"FormattingMarkedAria" = "Highlighted text";
"FormattingSubscriptAria" = "Subscript text";
"FormattingSuperscriptAria" = "Superscript text";
"FormattingAddDateAria" = "Add Date";
"FormattingAddLinkAria" = "Add Link";
"FormattingClearAria" = "Clear formatting";
"RemoveRichFormattingTitle" = "Remove Formatting?";
"RemoveRichFormattingText" = "This message uses rich formatting, which requires **Telegram Premium**.";
"RemoveRichFormatting" = "Remove Formatting";
"RichFormattingSubscribe" = "Subscribe to Premium";
"RichEditorBlockMenu" = "Insert block";
"RichEditorBlockPlaceholder" = "Type something";
"RichEditorParagraph" = "Paragraph";
"RichEditorHeading" = "Heading";
"RichEditorHeadingLevel" = "Heading {level}";
"RichEditorFooter" = "Footer";
"RichEditorSubheading" = "Subheading";
"RichEditorBlockquote" = "Quote";
"RichEditorPullquote" = "Pullquote";
"RichEditorPullquotePlaceholder" = "Type a quote here";
"RichEditorQuoteCaptionPlaceholder" = "Add author";
"RichEditorDetails" = "Details";
"RichEditorCodeBlock" = "Code block";
"RichEditorCodeLanguageAuto" = "Auto";
"RichEditorListMenu" = "Lists";
"RichEditorBulletList" = "Bulleted list";
"RichEditorOrderedList" = "Numbered list";
"RichEditorChecklist" = "Checklist";
"RichEditorListOptions" = "List options";
"RichEditorListCheckmarks" = "Checkmarks";
"RichEditorListNumberingType" = "Numbering type";
"RichEditorListNumberingDecimal" = "Numbers (1, 2, 3)";
"RichEditorListNumberingLowercaseLetters" = "Lowercase letters (a, b, c)";
"RichEditorListNumberingUppercaseLetters" = "Uppercase letters (A, B, C)";
"RichEditorListNumberingLowercaseRoman" = "Lowercase Roman (i, ii, iii)";
"RichEditorListNumberingUppercaseRoman" = "Uppercase Roman (I, II, III)";
"RichEditorListReverseOrder" = "Reverse order";
"RichEditorDivider" = "Divider";
"RichEditorTableMenu" = "Table";
"RichEditorTable" = "Table";
"RichEditorTableAlign" = "Alignment";
"RichEditorTableAlignLeft" = "Align left";
"RichEditorTableAlignCenter" = "Align center";
"RichEditorTableAlignRight" = "Align right";
"RichEditorTableAlignTop" = "Align top";
"RichEditorTableAlignMiddle" = "Align middle";
"RichEditorTableAlignBottom" = "Align bottom";
"RichEditorTableHighlight" = "Highlight";
"RichEditorTableRemoveHighlight" = "Remove highlight";
"RichEditorTableMergeCells" = "Merge cells";
"RichEditorTableSplitCell" = "Split cell";
"RichEditorTableInsert" = "Insert";
"RichEditorTableInsertColumnLeft" = "Insert column left";
"RichEditorTableInsertColumnRight" = "Insert column right";
"RichEditorTableInsertRowAbove" = "Insert row above";
"RichEditorTableInsertRowBelow" = "Insert row below";
"RichEditorTableMove" = "Move";
"RichEditorTableMoveLeft" = "Move left";
"RichEditorTableMoveRight" = "Move right";
"RichEditorTableMoveUp" = "Move up";
"RichEditorTableMoveDown" = "Move down";
"RichEditorTableDelete" = "Delete";
"RichEditorTableDeleteRow_one" = "Delete row";
"RichEditorTableDeleteRow_other" = "Delete {count} rows";
"RichEditorTableDeleteColumn_one" = "Delete column";
"RichEditorTableDeleteColumn_other" = "Delete {count} columns";
"RichEditorTableDeleteTable" = "Delete table";
"RichEditorTableActionsAria" = "Open table actions";
"RichEditorTableResizeSelectionAria" = "Resize cell selection";
"RichEditorTableSelectRowAria" = "Select row";
"RichEditorTableSelectColumnAria" = "Select column";
"RichEditorTableSelectTableAria" = "Select table";
"RichEditorTableStriped" = "Striped rows";
"RichEditorTableBorderless" = "Borderless";
"AriaComposerCloseRichInput" = "Collapse editor";
"RichEditorEquation" = "Equation";
"RichEditorEquationPrompt" = "Enter equation...";
"RichEditorEquationToBlock" = "Convert to block equation";
"RichEditorEquationToInline" = "Convert to inline equation";
"FormattingLinkUrl" = "URL";
...
"MonetizationInfoGramTitle" = "What is 💎 Gram?";
"ChannelEarnLearnCoinAbout" = "Gram is the cryptocurrency of the TON blockchain platform that Telegram uses for its high speed and low commissions on transactions. {link}";
...
"GiftValueDescription" = "The average sale price of **{giftName}** gifts on Telegram and Fragment over the past month.";
...
"BrowserMoreTabs_one" = "{title} & {count} Other";
"BrowserMoreTabs_other" = "{title} & {count} Others";
...
"Apps" = "Apps";
"AreYouSureCloseBrowserTabs" = "Are you sure you want to close all browser tabs?";
"CloseBrowserTabs" = "Close Browser Tabs";
...
"ViewButtonInstantView" = "INSTANT VIEW";
...
"ActionSuggestedBirthdayYou" = "You suggested {user} to add a birthday";
"ActionSuggestedBirthday" = "{user} suggested you add your birthday";
...
"ActionGiftCodeSubscriptionDurationYou" = "You sent {peer} a gift code for {duration} of Telegram Premium.";
...
"GramAmount" = "💎{amount}";
"GramAmountText_one" = "{amount} Gram";
"GramAmountText_other" = "{amount} Gram";
...
"FrozenAccountViolationSubtitle" = "Your account was frozen for breaking Telegram’s Terms of Service";
...
"EnterPriceInGram" = "Enter Price in Gram";
"SuggestMessagePriceDescriptionStars" = "Choose how many Stars to pay to publish this post.";
"SuggestMessagePriceDescriptionGram" = "Choose how many Gram to pay to publish this post.";
...
"DescriptionAboutGram" = "Offer Gram to submit post suggestions to channels on Telegram.";
"ButtonTopUpViaFragment" = "Top Up Via Fragment";
"GramModalHint" = "You can top up your Gram using Fragment.";
"GramGiftReceived" = "Gram Top-Up";
...
"OnlyAcceptGram" = "Only Accept Gram";
"OnlyAcceptGramDescription" = "If the buyer pays you in Gram, there is no risk of refunds, unlike Star payments.";
"DescriptionPayInGram" = "Pay with Gram to skip the 21-day wait before transferring the gift again.";
"LabelPayInGram" = "Pay in Gram";
...
"InstantViewWrongLayout" = "Wrong layout?";
...
"RGB" = "RGB";
"Text" = "Text";
"ConfirmBuyGiftForGramDescription" = "The seller only accepts Gram as payment.";
...
"HeaderMenuViewProfile" = "View profile";
"HeaderMenuViewGroupInfo" = "View group info";
"HeaderMenuViewTopicInfo" = "View topic info";
...
"BirthdayTitleForPeer" = "{user}'s Date of Birth";
"BirthdaySuggest" = "Suggest Date of Birth";
"BirthdayAddToProfile" = "Add to My Profile";
"BirthdayHideYear" = "Hide Year";
"SettingsBirthday" = "Birthday";
"PersonalChannelLabel" = "Channel";
"PersonalChannelAdd" = "Add";
"PersonalChannelTitle" = "Personal Channel";
"PersonalChannelDescription" = "Display the channel you manage in your profile.";
"PersonalChannelPickerTitle" = "Select Channel";
"PersonalChannelNoChannels" = "You have no eligible channels.";
"PersonalChannelRemove" = "Remove Channel";
...
"AiToneEditorTitle" = "Create AI Style";
"AiToneEditorNamePlaceholder" = "Style Name (for example: Pirate)";
"AiToneEditorPromptPlaceholder" = "Instructions (for example, \\"Write like a swashbuckling pirate. Use arr, ye, matey, and talk about treasure and the sea\\")";
...
"AiTonePreviewUsedBy2_one" = "Used by {count} person.";
"AiTonePreviewUsedBy2_other" = "Used by {count} people.";
...
"AiSidebar.EmptyTitle" = "Ask anything about this chat";
"AiSidebar.EmptyText" = "Conversations stay in Telegram. The model only sees messages you select.";
"AiSidebar.Loading" = "Loading…";
"AiSidebar.ErrorTitle" = "Something went wrong";
"AiSidebar.ErrorUnknown" = "Unknown error";
"AiSidebar.Retry" = "Retry";
"AiSidebar.Assistant" = "Assistant";
"AiSidebar.You" = "You";
"AiSidebar.DisabledTitle" = "AI sidebar is not available";
"AiSidebar.DisabledText" = "Enable the AI sidebar from the feature flag and reload.";
"AiSidebar.InputPlaceholder" = "Message AI…";
"AiSidebar.Send" = "Send";
"AiSidebar.QuickCommandsTitle" = "Quick commands";
"AiSidebar.QuickCommandSummarizeNew" = "Summarize new messages";
"AiSidebar.QuickCommandSummarizeAll" = "Summarize all loaded messages";
"AiSidebar.QuickCommandKeyPoints" = "Extract key points";
"AiSidebar.QuickCommandActionItems" = "List action items";
"AiSidebar.QuickCommandTranslate" = "Translate to English";
"AiSidebar.PromptSummarizeNew" = "Summarize the new messages in this chat since I last looked. Be concise — 3-5 bullet points.";
"AiSidebar.PromptSummarizeAll" = "Summarize all currently loaded messages in this chat into a short paragraph.";
"AiSidebar.PromptKeyPoints" = "Extract the key points from the loaded messages as a numbered list.";
"AiSidebar.PromptActionItems" = "List action items, tasks, and follow-ups mentioned in the loaded messages.";
"AiSidebar.PromptTranslate" = "Translate the loaded non-English messages into English.";
"AiSidebar.OpenSettings" = "Settings";
"AiSidebar.SettingsEndpoint" = "Endpoint URL";
"AiSidebar.SettingsModel" = "Model";
"AiSidebar.SettingsApiKey" = "API key";
"AiSidebar.SettingsSave" = "Save";
"AiSidebar.SettingsHint" = "Defaults are applied automatically when you paste a key.";
"AiSidebar.ApiKeyRequiredTitle" = "API key required";
"AiSidebar.ApiKeyRequiredText" = "Add an OpenAI-compatible API key to start chatting with the assistant.";
"AiSidebar.Streaming" = "Streaming…";
"AiSidebar.Cancel" = "Cancel";
"AiMcp.LocalTitle" = "Local MCP";
"AiMcp.ModesTitle" = "Telegram MCP modes";
"AiMcp.LocalDescription" = "Uses the Telegram session already open in this browser tab. The browser relay is temporary and stops when you disable it or close the tab.";
"AiMcp.LocalToggleDescription" = "Browser-owned session. This is separate from the server MCP connection.";
"AiMcp.LocalRuntime" = "Telegram session owner:";
"AiMcp.LocalRelay" = "Browser relay:";
"AiMcp.ThisTab" = "this tab";
"AiMcp.AnotherTab" = "another tab";
"AiMcp.Connected" = "connected";
"AiMcp.Disconnected" = "disconnected";
"AiMcp.AllowWrite" = "Allow MCP to send messages";
"AiMcp.AllowWriteDescription" = "Disabled by default. Reading remains available. Sending and other writes require this permission.";
"AiMcp.EnableLocal" = "Enable local MCP";
"AiMcp.DisableLocal" = "Disable local MCP";
"AiMcp.LocalEndpoint" = "Local MCP endpoint:";
"AiMcp.BearerToken" = "Bearer token:";
"AiMcp.WritePermission" = "Write permission:";
"AiMcp.CopyEndpoint" = "Copy endpoint";
"AiMcp.CopyBearer" = "Copy bearer token";
"AiMcp.CopyServerEndpoint" = "Copy server MCP endpoint";
"AiMcp.Copied" = "Copied";
"AiMcp.CopyFailed" = "Could not copy MCP endpoint.";
"AiMcp.RevokeLocal" = "Revoke local MCP";
"AiMcp.ServerTitle" = "Server MCP";
"AiMcp.ServerDescription" = "Uses a Telegram session stored by the MCP server. ChatGPT connects through OAuth. This switch only records that you want the server mode.";
"AiMcp.ServerEndpoint" = "Server MCP endpoint:";
"AiMcp.ServerManagedExternally" = "The ChatGPT connection and Telegram authorization are managed in ChatGPT. Local MCP and server MCP can be enabled independently.";
`;export{e as default};
//# sourceMappingURL=fallback-DIBdBhor.js.map